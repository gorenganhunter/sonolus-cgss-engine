...
import { getNoteDuration } from "../../../../../shared/src/engine/data/utils"
...
export class Initialization extends Archetype {
    preprocess() {
        ...
        note.duration = getNoteDuration(options.noteSpeed)
