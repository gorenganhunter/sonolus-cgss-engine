...
export class BaseConnector extends Archetype {
    ...
    preprocess() {
        ...
        this.visualTime.min = this.head.spawnTime
    ...
    get shouldScheduleSFX() {
        return options.sfxEnabled && this.headImport.visible >= 0
    }
    ...
    get endSharedMemory() {
        return archetypes.SlideStartNote.sharedMemory.get(this.import.tailRef)
    }
    ...
    get tailImport() {
        return archetypes.SlideEndNote.import.get(this.import.tailRef)
    }
